document.addEventListener("DOMContentLoaded", function() {
  ...
  // ==========================================
  // MOBILE HEADER SCROLL VISIBILITY
  // ==========================================
  if (siteHeader) {
  ...
  // ==========================================
  // INDIVIDUAL EXPAND/COLLAPSE LOGIC
  // ==========================================
  function IndivClick() {
    collapsibles.forEach(function(btn, index) {
      btn.dataset.index = index; 
      btn.addEventListener("click", function() {
        //ENGAGE THE LOCK: Stop the scroll trigger from firing
  ...
  // ==========================================
  // Defining the function of header-height variable
